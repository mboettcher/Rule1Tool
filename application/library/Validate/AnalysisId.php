...
class Validate_AnalysisId extends Zend_Validate_Abstract
{
    const MSG_NOTFOUND = 'analysisIdNotFound';

    protected $_messageTemplates = array(
        self::MSG_NOTFOUND 	=> "Die angegebene Analysis-ID '%value%' existiert nicht",
    );
    /**
