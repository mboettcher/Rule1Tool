...
class Validate_ReplyId extends Zend_Validate_Abstract
{
    const MSG_NOTFOUND = 'replyIdNotFound';

    protected $_messageTemplates = array(
        self::MSG_NOTFOUND 	=> "Die angegebene Beitrags-ID '%value%' existiert nicht"
    );
    /**
