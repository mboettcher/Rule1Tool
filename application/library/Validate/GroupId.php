...
class Validate_GroupId extends Zend_Validate_Abstract
{
    const MSG_NOTFOUND = 'groupeIdNotFound';

    protected $_messageTemplates = array(
        self::MSG_NOTFOUND 	=> "Die angegebene Gruppen-ID '%value%' existiert nicht"
    );
    /**
